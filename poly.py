...
class LinkedList:
    "Contains the information to create a Linked List"
    def __init__(self):
    ...
    def insert_term(self, coeff, exp):
        "Allows user to insert term into Linked List"
        if coeff == 0:
            return
    ...
    def add(self, p):
        "Allows two polynomials to be added"
        new_list = LinkedList()
    ...
    def mult(self, p):
        "Allows two polynomials to be multiplied together"
